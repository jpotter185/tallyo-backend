    ...
    public Game toGame(Event event, League league) {
        ...
        Game game = Game.builder()
                ...
                .awayTimeouts(Optional.ofNullable(competition.getSituation())
                        ...
                        .orElse(0))
                .balls(Optional.ofNullable(competition.getSituation())
                        .map(Situation::getBalls)
                        .orElse(null))
                .strikes(Optional.ofNullable(competition.getSituation())
                        .map(Situation::getStrikes)
                        .orElse(null))
                .outs(Optional.ofNullable(competition.getSituation())
                        .map(Situation::getOuts)
                        .orElse(null))
